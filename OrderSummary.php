...
<?php
$q="select fastfood_order.*,registration.emailid from fastfood_order join registration on registration.r_id=fastfood_order.r_id where fastfood_order.status='Dispatch' order by order_id";
$a=$db->fetch_all_array($q);
echo "<table>";
echo "<tr><td colspan=6 class=formtitle>Orders Summary</td></tr>";
echo "<tr>";

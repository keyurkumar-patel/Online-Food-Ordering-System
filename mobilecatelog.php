...
if(isset($_SESSION["products"]))
{
    ...
    foreach ($_SESSION["products"] as $cart_itm)
    {
        ...
        echo '<span class="remove-itm"><a href="mobile_cart_update.php?removep='.$cart_itm["code"].'&return_url='.$current_url.'">&times;</a></span>';
    ...
    echo '</ol>';
    echo '<span class="check-out-txt"><strong>Total : '.$currency.$total.'</strong> <a href="mobile_view_cart.php">Check-out!</a></span>';
	echo '<span class="empty-cart"><a href="mobile_cart_update.php?emptycart=1&return_url='.$current_url.'">Empty Cart</a></span>';
}else{

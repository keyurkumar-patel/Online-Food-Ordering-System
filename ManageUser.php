...
echo "<table>";
echo "<tr><td colspan=6 class=formtitle>Manage User</td></tr>";
echo "<tr>";
...
echo"<td>Fname:-{$v['fname']}</td>";
echo"<td>Lname:-{$v['lname']}</td>";
echo"<td>Email-id:-{$v['emailid']}</td>";
echo"<td><a href=Userdetails.php?r_id={$v['r_id']}>Details</a></td>";
echo"</tr>";

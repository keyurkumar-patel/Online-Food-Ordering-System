...
<div id="wrapper">
  ...
  <tr>
    <td valign="top"><table width="700">
          ...
          <div class="post">
                  ...
                  <table width="750" class="formtable" >
                    <tr>
                      <td class="formtitle">Edit Profile</td>
                      </tr>
                    <tr>
                      <td>
                        <?php
	...
	mysql_query("update registration set fname='$firstname',lname='$lastname',address='$address',city='$city',state='$state',pincode='$pincode' where EmailID='$_SESSION[email]'") or die(mysql_error());

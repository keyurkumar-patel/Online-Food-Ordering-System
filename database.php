    ...
    private function exception($message) {
        ...
        ;echo ' 
            <div class="alert-bad">
                ...
                <div>
                    Message: '; echo $message; ;echo '                </div>
                '; if (strlen($this->error) > 0): ;echo '                    <div>
                        '; echo $this->error; ;echo '                    </div>
                '; endif; ;echo '                <div>
                    Script: '; echo @$_SERVER['REQUEST_URI']; ;echo '                </div>
                '; if (strlen(@$_SERVER['HTTP_REFERER']) > 0): ;echo '                    <div>
                        '; echo @$_SERVER['HTTP_REFERER']; ;echo '                    </div>
                '; endif; ;echo '            </div>
        ';
        } else {
